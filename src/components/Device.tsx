      ...
      <div className="device boot mx-auto flex w-full min-h-0 max-w-6xl flex-1 flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between gap-3 px-3 py-2 sm:px-4 sm:py-3">
          <div className="flex items-center gap-2">
            <PixelHeart size={18} color="var(--color-on-bezel)" className="beat" />
            <h1 className="font-[family-name:var(--font-display)] text-lg font-bold tracking-wide text-[var(--color-on-bezel)] sm:text-xl">
              our dates
            </h1>
          </div>
